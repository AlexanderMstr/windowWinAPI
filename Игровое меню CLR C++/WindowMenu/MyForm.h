...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) //€зык
{

	language^ f2 = gcnew language(); //создаем новое окно (€зык)
	f2->Owner = this;//€зык- назад
	f2->Show(); //открываем
	MyForm::Hide(); //скрываем меню
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) //закрыть
{
	MyForm::Close();
	
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) //»гра
{
	Game^ f5 = gcnew Game();
	f5->Owner = this;
	f5->Show();
