...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"Инвентарь";
			this->Text = L"Инвентарь";
			this->Load += gcnew System::EventHandler(this, &inventory::Инвентрь_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void Инвентрь_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	};
}
